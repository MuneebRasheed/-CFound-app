    ...
    return (
        <View style={{ alignItems: 'center' }}>
            <View style={{ flexDirection: 'row', width: '90%', backgroundColor: 'white', paddingRight: 19 }}>
                ...
                <TouchableOpacity style={{ flexDirection: 'row', width: '80%', justifyContent: 'space-between', height: 70, marginTop: '3%' }}
                >
                    <View>
                        <Text style={{ fontSize: 18, color: 'black', fontWeight: 'bold', marginBottom: '2%' }}>{"Laiba"}</Text>
